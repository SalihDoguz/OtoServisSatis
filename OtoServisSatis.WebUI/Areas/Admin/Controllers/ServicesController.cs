...
namespace OtoServisSatis.WebUI.Areas.Admin.Controllers
{
    ...
    public class ServicesController : Controller
    {
        ...
        public ServicesController(IService<Servis> servis)
        {
            _service = servis;
        }

        // GET: ServicesController
        public async Task<ActionResult> IndexAsync() // listele
        {
        ...
        public async Task<ActionResult> EditAsync(int id, Servis servis)
        {
            if (ModelState.IsValid)
            {
                ...
                {
                    ModelState.AddModelError("", "Servis kaydı güncellenirken hata oluştu!");
                }
            }
            return View(servis);
        }
